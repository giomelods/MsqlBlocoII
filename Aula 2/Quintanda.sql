...
between '2022-03-10' and '2022-03-15' order by dtvalidade desc;
...
-- mais usado ele tras o que está na chave estrangeira
SELECT nome, preco, tb_categorias.descricao from tb_produtos inner join tb_categorias
on tb_produtos.categoria_id = tb_categorias.id;
-- tudo o que o inner tras e o da esquerda
SELECT nome, preco, tb_categorias.descricao from tb_produtos left join tb_categorias
on tb_produtos.categoria_id = tb_categorias.id;
-- o que não estava aparecendo da direita
SELECT nome, preco, tb_categorias.descricao from tb_produtos right join tb_categorias
on tb_produtos.categoria_id = tb_categorias.id;
